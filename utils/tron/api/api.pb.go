...
import (
	...
	reflect "reflect"
	sync "sync"
	core2 "walletSynV2/utils/tron/core"
)
...
var file_api_api_proto_goTypes = []interface{}{
	...
	(*core2.Witness)(nil),                           // 82: protocol.Witness
	(*core2.Proposal)(nil),                          // 83: protocol.Proposal
	(*core2.Exchange)(nil),                          // 84: protocol.Exchange
	(*core2.AssetIssueContract)(nil),                // 85: protocol.AssetIssueContract
	(*core2.Block)(nil),                             // 86: protocol.Block
	(*core2.Transaction)(nil),                       // 87: protocol.Transaction
	(*core2.DelegatedResource)(nil),                 // 88: protocol.DelegatedResource
	(*core2.Account)(nil),                           // 89: protocol.Account
	(*core2.BlockHeader)(nil),                       // 90: protocol.BlockHeader
	(*core2.IncrementalMerkleTree)(nil),             // 91: protocol.IncrementalMerkleTree
	(*core2.Permission)(nil),                        // 92: protocol.Permission
	(*core2.IncrementalMerkleVoucher)(nil),          // 93: protocol.IncrementalMerkleVoucher
	(*core2.TransactionInfo)(nil),                   // 94: protocol.TransactionInfo
	(*core2.SpendDescription)(nil),                  // 95: protocol.SpendDescription
	(*core2.ReceiveDescription)(nil),                // 96: protocol.ReceiveDescription
	(*core2.AccountBalanceRequest)(nil),             // 97: protocol.AccountBalanceRequest
	(*core2.BlockBalanceTrace_BlockIdentifier)(nil), // 98: protocol.BlockBalanceTrace.BlockIdentifier
	(*core2.TransferContract)(nil),                  // 99: protocol.TransferContract
	(*core2.AccountUpdateContract)(nil),             // 100: protocol.AccountUpdateContract
	(*core2.SetAccountIdContract)(nil),              // 101: protocol.SetAccountIdContract
	(*core2.VoteWitnessContract)(nil),               // 102: protocol.VoteWitnessContract
	(*core2.UpdateSettingContract)(nil),             // 103: protocol.UpdateSettingContract
	(*core2.UpdateEnergyLimitContract)(nil),         // 104: protocol.UpdateEnergyLimitContract
	(*core2.WitnessUpdateContract)(nil),             // 105: protocol.WitnessUpdateContract
	(*core2.AccountCreateContract)(nil),             // 106: protocol.AccountCreateContract
	(*core2.WitnessCreateContract)(nil),             // 107: protocol.WitnessCreateContract
	(*core2.TransferAssetContract)(nil),             // 108: protocol.TransferAssetContract
	(*core2.ParticipateAssetIssueContract)(nil),     // 109: protocol.ParticipateAssetIssueContract
	(*core2.FreezeBalanceContract)(nil),             // 110: protocol.FreezeBalanceContract
	(*core2.UnfreezeBalanceContract)(nil),           // 111: protocol.UnfreezeBalanceContract
	(*core2.UnfreezeAssetContract)(nil),             // 112: protocol.UnfreezeAssetContract
	(*core2.WithdrawBalanceContract)(nil),           // 113: protocol.WithdrawBalanceContract
	(*core2.UpdateAssetContract)(nil),               // 114: protocol.UpdateAssetContract
	(*core2.ProposalCreateContract)(nil),            // 115: protocol.ProposalCreateContract
	(*core2.ProposalApproveContract)(nil),           // 116: protocol.ProposalApproveContract
	(*core2.ProposalDeleteContract)(nil),            // 117: protocol.ProposalDeleteContract
	(*core2.BuyStorageContract)(nil),                // 118: protocol.BuyStorageContract
	(*core2.BuyStorageBytesContract)(nil),           // 119: protocol.BuyStorageBytesContract
	(*core2.SellStorageContract)(nil),               // 120: protocol.SellStorageContract
	(*core2.ExchangeCreateContract)(nil),            // 121: protocol.ExchangeCreateContract
	(*core2.ExchangeInjectContract)(nil),            // 122: protocol.ExchangeInjectContract
	(*core2.ExchangeWithdrawContract)(nil),          // 123: protocol.ExchangeWithdrawContract
	(*core2.ExchangeTransactionContract)(nil),       // 124: protocol.ExchangeTransactionContract
	(*core2.MarketSellAssetContract)(nil),           // 125: protocol.MarketSellAssetContract
	(*core2.MarketCancelOrderContract)(nil),         // 126: protocol.MarketCancelOrderContract
	(*core2.MarketOrderPair)(nil),                   // 127: protocol.MarketOrderPair
	(*core2.CreateSmartContract)(nil),               // 128: protocol.CreateSmartContract
	(*core2.TriggerSmartContract)(nil),              // 129: protocol.TriggerSmartContract
	(*core2.ClearABIContract)(nil),                  // 130: protocol.ClearABIContract
	(*core2.TransactionSign)(nil),                   // 131: protocol.TransactionSign
	(*core2.AccountPermissionUpdateContract)(nil),   // 132: protocol.AccountPermissionUpdateContract
	(*core2.UpdateBrokerageContract)(nil),           // 133: protocol.UpdateBrokerageContract
	(*core2.OutputPointInfo)(nil),                   // 134: protocol.OutputPointInfo
	(*core2.AccountBalanceResponse)(nil),            // 135: protocol.AccountBalanceResponse
	(*core2.BlockBalanceTrace)(nil),                 // 136: protocol.BlockBalanceTrace
	(*core2.MarketOrder)(nil),                       // 137: protocol.MarketOrder
	(*core2.MarketOrderList)(nil),                   // 138: protocol.MarketOrderList
	(*core2.MarketPriceList)(nil),                   // 139: protocol.MarketPriceList
	(*core2.MarketOrderPairList)(nil),               // 140: protocol.MarketOrderPairList
	(*core2.SmartContract)(nil),                     // 141: protocol.SmartContract
	(*core2.SmartContractDataWrapper)(nil),          // 142: protocol.SmartContractDataWrapper
	(*core2.DelegatedResourceAccountIndex)(nil),     // 143: protocol.DelegatedResourceAccountIndex
	(*core2.ChainParameters)(nil),                   // 144: protocol.ChainParameters
	(*core2.NodeInfo)(nil),                          // 145: protocol.NodeInfo
	(*core2.IncrementalMerkleVoucherInfo)(nil),      // 146: protocol.IncrementalMerkleVoucherInfo
	(*core2.DynamicProperties)(nil),                 // 147: protocol.DynamicProperties
	(*core2.MetricsInfo)(nil),                       // 148: protocol.MetricsInfo
}
...
type WalletClient interface {
	GetAccount(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*core2.Account, error)
	GetAccountById(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*core2.Account, error)
	GetAccountBalance(ctx context.Context, in *core2.AccountBalanceRequest, opts ...grpc.CallOption) (*core2.AccountBalanceResponse, error)
	GetBlockBalanceTrace(ctx context.Context, in *core2.BlockBalanceTrace_BlockIdentifier, opts ...grpc.CallOption) (*core2.BlockBalanceTrace, error)
	//Please use CreateTransaction2 instead of this function.
	CreateTransaction(ctx context.Context, in *core2.TransferContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of CreateTransaction.
	CreateTransaction2(ctx context.Context, in *core2.TransferContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	BroadcastTransaction(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*Return, error)
	//Please use UpdateAccount2 instead of this function.
	UpdateAccount(ctx context.Context, in *core2.AccountUpdateContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	SetAccountId(ctx context.Context, in *core2.SetAccountIdContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of UpdateAccount.
	UpdateAccount2(ctx context.Context, in *core2.AccountUpdateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use VoteWitnessAccount2 instead of this function.
	VoteWitnessAccount(ctx context.Context, in *core2.VoteWitnessContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//modify the consume_user_resource_percent
	UpdateSetting(ctx context.Context, in *core2.UpdateSettingContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//modify the energy_limit
	UpdateEnergyLimit(ctx context.Context, in *core2.UpdateEnergyLimitContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Use this function instead of VoteWitnessAccount.
	VoteWitnessAccount2(ctx context.Context, in *core2.VoteWitnessContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use CreateAssetIssue2 instead of this function.
	CreateAssetIssue(ctx context.Context, in *core2.AssetIssueContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of CreateAssetIssue.
	CreateAssetIssue2(ctx context.Context, in *core2.AssetIssueContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use UpdateWitness2 instead of this function.
	UpdateWitness(ctx context.Context, in *core2.WitnessUpdateContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of UpdateWitness.
	UpdateWitness2(ctx context.Context, in *core2.WitnessUpdateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use CreateAccount2 instead of this function.
	CreateAccount(ctx context.Context, in *core2.AccountCreateContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of CreateAccount.
	CreateAccount2(ctx context.Context, in *core2.AccountCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use CreateWitness2 instead of this function.
	CreateWitness(ctx context.Context, in *core2.WitnessCreateContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of CreateWitness.
	CreateWitness2(ctx context.Context, in *core2.WitnessCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use TransferAsset2 instead of this function.
	TransferAsset(ctx context.Context, in *core2.TransferAssetContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of TransferAsset.
	TransferAsset2(ctx context.Context, in *core2.TransferAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use ParticipateAssetIssue2 instead of this function.
	ParticipateAssetIssue(ctx context.Context, in *core2.ParticipateAssetIssueContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of ParticipateAssetIssue.
	ParticipateAssetIssue2(ctx context.Context, in *core2.ParticipateAssetIssueContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use FreezeBalance2 instead of this function.
	FreezeBalance(ctx context.Context, in *core2.FreezeBalanceContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of FreezeBalance.
	FreezeBalance2(ctx context.Context, in *core2.FreezeBalanceContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use UnfreezeBalance2 instead of this function.
	UnfreezeBalance(ctx context.Context, in *core2.UnfreezeBalanceContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of UnfreezeBalance.
	UnfreezeBalance2(ctx context.Context, in *core2.UnfreezeBalanceContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use UnfreezeAsset2 instead of this function.
	UnfreezeAsset(ctx context.Context, in *core2.UnfreezeAssetContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of UnfreezeAsset.
	UnfreezeAsset2(ctx context.Context, in *core2.UnfreezeAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use WithdrawBalance2 instead of this function.
	WithdrawBalance(ctx context.Context, in *core2.WithdrawBalanceContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of WithdrawBalance.
	WithdrawBalance2(ctx context.Context, in *core2.WithdrawBalanceContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Please use UpdateAsset2 instead of this function.
	UpdateAsset(ctx context.Context, in *core2.UpdateAssetContract, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Use this function instead of UpdateAsset.
	UpdateAsset2(ctx context.Context, in *core2.UpdateAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ProposalCreate(ctx context.Context, in *core2.ProposalCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ProposalApprove(ctx context.Context, in *core2.ProposalApproveContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ProposalDelete(ctx context.Context, in *core2.ProposalDeleteContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	BuyStorage(ctx context.Context, in *core2.BuyStorageContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	BuyStorageBytes(ctx context.Context, in *core2.BuyStorageBytesContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	SellStorage(ctx context.Context, in *core2.SellStorageContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ExchangeCreate(ctx context.Context, in *core2.ExchangeCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ExchangeInject(ctx context.Context, in *core2.ExchangeInjectContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ExchangeWithdraw(ctx context.Context, in *core2.ExchangeWithdrawContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ExchangeTransaction(ctx context.Context, in *core2.ExchangeTransactionContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	MarketSellAsset(ctx context.Context, in *core2.MarketSellAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	MarketCancelOrder(ctx context.Context, in *core2.MarketCancelOrderContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	GetMarketOrderById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.MarketOrder, error)
	GetMarketOrderByAccount(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.MarketOrderList, error)
	GetMarketPriceByPair(ctx context.Context, in *core2.MarketOrderPair, opts ...grpc.CallOption) (*core2.MarketPriceList, error)
	GetMarketOrderListByPair(ctx context.Context, in *core2.MarketOrderPair, opts ...grpc.CallOption) (*core2.MarketOrderList, error)
	GetMarketPairList(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.MarketOrderPairList, error)
	ListNodes(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*NodeList, error)
	GetAssetIssueByAccount(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*AssetIssueList, error)
	GetAccountNet(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*AccountNetMessage, error)
	GetAccountResource(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*AccountResourceMessage, error)
	GetAssetIssueByName(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.AssetIssueContract, error)
	GetAssetIssueListByName(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*AssetIssueList, error)
	GetAssetIssueById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.AssetIssueContract, error)
	//Please use GetNowBlock2 instead of this function.
	GetNowBlock(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.Block, error)
	...
	GetBlockByNum(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*core2.Block, error)
	...
	GetBlockById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Block, error)
	...
	GetTransactionById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Transaction, error)
	DeployContract(ctx context.Context, in *core2.CreateSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	GetContract(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.SmartContract, error)
	GetContractInfo(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.SmartContractDataWrapper, error)
	TriggerContract(ctx context.Context, in *core2.TriggerSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	TriggerConstantContract(ctx context.Context, in *core2.TriggerSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	ClearContractABI(ctx context.Context, in *core2.ClearABIContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	...
	GetDelegatedResourceAccountIndex(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.DelegatedResourceAccountIndex, error)
	...
	GetProposalById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Proposal, error)
	...
	GetExchangeById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Exchange, error)
	GetChainParameters(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.ChainParameters, error)
	...
	GetTransactionSign(ctx context.Context, in *core2.TransactionSign, opts ...grpc.CallOption) (*core2.Transaction, error)
	//Warning: do not invoke this interface provided by others.
	//Use this function instead of GetTransactionSign.
	GetTransactionSign2(ctx context.Context, in *core2.TransactionSign, opts ...grpc.CallOption) (*TransactionExtention, error)
	//Warning: do not invoke this interface provided by others.
	...
	GetTransactionInfoById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.TransactionInfo, error)
	AccountPermissionUpdate(ctx context.Context, in *core2.AccountPermissionUpdateContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	AddSign(ctx context.Context, in *core2.TransactionSign, opts ...grpc.CallOption) (*TransactionExtention, error)
	GetTransactionSignWeight(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*TransactionSignWeight, error)
	GetTransactionApprovedList(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*TransactionApprovedList, error)
	GetNodeInfo(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.NodeInfo, error)
	...
	UpdateBrokerage(ctx context.Context, in *core2.UpdateBrokerageContract, opts ...grpc.CallOption) (*TransactionExtention, error)
	...
	GetMerkleTreeVoucherInfo(ctx context.Context, in *core2.OutputPointInfo, opts ...grpc.CallOption) (*core2.IncrementalMerkleVoucherInfo, error)
	...
	GetShieldTransactionHash(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*BytesMessage, error)
	...
	CreateCommonTransaction(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*TransactionExtention, error)
	...
	GetTransactionFromPending(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Transaction, error)
...
func (c *walletClient) GetAccount(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*core2.Account, error) {
	out := new(core2.Account)
...
func (c *walletClient) GetAccountById(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*core2.Account, error) {
	out := new(core2.Account)
...
func (c *walletClient) GetAccountBalance(ctx context.Context, in *core2.AccountBalanceRequest, opts ...grpc.CallOption) (*core2.AccountBalanceResponse, error) {
	out := new(core2.AccountBalanceResponse)
...
func (c *walletClient) GetBlockBalanceTrace(ctx context.Context, in *core2.BlockBalanceTrace_BlockIdentifier, opts ...grpc.CallOption) (*core2.BlockBalanceTrace, error) {
	out := new(core2.BlockBalanceTrace)
...
func (c *walletClient) CreateTransaction(ctx context.Context, in *core2.TransferContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) CreateTransaction2(ctx context.Context, in *core2.TransferContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
...
func (c *walletClient) BroadcastTransaction(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*Return, error) {
	out := new(Return)
...
func (c *walletClient) UpdateAccount(ctx context.Context, in *core2.AccountUpdateContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) SetAccountId(ctx context.Context, in *core2.SetAccountIdContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) UpdateAccount2(ctx context.Context, in *core2.AccountUpdateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) VoteWitnessAccount(ctx context.Context, in *core2.VoteWitnessContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) UpdateSetting(ctx context.Context, in *core2.UpdateSettingContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) UpdateEnergyLimit(ctx context.Context, in *core2.UpdateEnergyLimitContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) VoteWitnessAccount2(ctx context.Context, in *core2.VoteWitnessContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) CreateAssetIssue(ctx context.Context, in *core2.AssetIssueContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) CreateAssetIssue2(ctx context.Context, in *core2.AssetIssueContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) UpdateWitness(ctx context.Context, in *core2.WitnessUpdateContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) UpdateWitness2(ctx context.Context, in *core2.WitnessUpdateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) CreateAccount(ctx context.Context, in *core2.AccountCreateContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) CreateAccount2(ctx context.Context, in *core2.AccountCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) CreateWitness(ctx context.Context, in *core2.WitnessCreateContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) CreateWitness2(ctx context.Context, in *core2.WitnessCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) TransferAsset(ctx context.Context, in *core2.TransferAssetContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) TransferAsset2(ctx context.Context, in *core2.TransferAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ParticipateAssetIssue(ctx context.Context, in *core2.ParticipateAssetIssueContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) ParticipateAssetIssue2(ctx context.Context, in *core2.ParticipateAssetIssueContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) FreezeBalance(ctx context.Context, in *core2.FreezeBalanceContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) FreezeBalance2(ctx context.Context, in *core2.FreezeBalanceContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) UnfreezeBalance(ctx context.Context, in *core2.UnfreezeBalanceContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) UnfreezeBalance2(ctx context.Context, in *core2.UnfreezeBalanceContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) UnfreezeAsset(ctx context.Context, in *core2.UnfreezeAssetContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) UnfreezeAsset2(ctx context.Context, in *core2.UnfreezeAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) WithdrawBalance(ctx context.Context, in *core2.WithdrawBalanceContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) WithdrawBalance2(ctx context.Context, in *core2.WithdrawBalanceContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) UpdateAsset(ctx context.Context, in *core2.UpdateAssetContract, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) UpdateAsset2(ctx context.Context, in *core2.UpdateAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ProposalCreate(ctx context.Context, in *core2.ProposalCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ProposalApprove(ctx context.Context, in *core2.ProposalApproveContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ProposalDelete(ctx context.Context, in *core2.ProposalDeleteContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) BuyStorage(ctx context.Context, in *core2.BuyStorageContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) BuyStorageBytes(ctx context.Context, in *core2.BuyStorageBytesContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) SellStorage(ctx context.Context, in *core2.SellStorageContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ExchangeCreate(ctx context.Context, in *core2.ExchangeCreateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ExchangeInject(ctx context.Context, in *core2.ExchangeInjectContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ExchangeWithdraw(ctx context.Context, in *core2.ExchangeWithdrawContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ExchangeTransaction(ctx context.Context, in *core2.ExchangeTransactionContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) MarketSellAsset(ctx context.Context, in *core2.MarketSellAssetContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) MarketCancelOrder(ctx context.Context, in *core2.MarketCancelOrderContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetMarketOrderById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.MarketOrder, error) {
	out := new(core2.MarketOrder)
...
func (c *walletClient) GetMarketOrderByAccount(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.MarketOrderList, error) {
	out := new(core2.MarketOrderList)
...
func (c *walletClient) GetMarketPriceByPair(ctx context.Context, in *core2.MarketOrderPair, opts ...grpc.CallOption) (*core2.MarketPriceList, error) {
	out := new(core2.MarketPriceList)
...
func (c *walletClient) GetMarketOrderListByPair(ctx context.Context, in *core2.MarketOrderPair, opts ...grpc.CallOption) (*core2.MarketOrderList, error) {
	out := new(core2.MarketOrderList)
...
func (c *walletClient) GetMarketPairList(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.MarketOrderPairList, error) {
	out := new(core2.MarketOrderPairList)
...
func (c *walletClient) GetAssetIssueByAccount(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*AssetIssueList, error) {
...
func (c *walletClient) GetAccountNet(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*AccountNetMessage, error) {
...
func (c *walletClient) GetAccountResource(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*AccountResourceMessage, error) {
...
func (c *walletClient) GetAssetIssueByName(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.AssetIssueContract, error) {
	out := new(core2.AssetIssueContract)
...
func (c *walletClient) GetAssetIssueById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.AssetIssueContract, error) {
	out := new(core2.AssetIssueContract)
...
func (c *walletClient) GetNowBlock(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
func (c *walletClient) GetBlockByNum(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
func (c *walletClient) GetBlockById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
func (c *walletClient) GetTransactionById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) DeployContract(ctx context.Context, in *core2.CreateSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetContract(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.SmartContract, error) {
	out := new(core2.SmartContract)
...
func (c *walletClient) GetContractInfo(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.SmartContractDataWrapper, error) {
	out := new(core2.SmartContractDataWrapper)
...
func (c *walletClient) TriggerContract(ctx context.Context, in *core2.TriggerSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) TriggerConstantContract(ctx context.Context, in *core2.TriggerSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) ClearContractABI(ctx context.Context, in *core2.ClearABIContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetDelegatedResourceAccountIndex(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.DelegatedResourceAccountIndex, error) {
	out := new(core2.DelegatedResourceAccountIndex)
...
func (c *walletClient) GetProposalById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Proposal, error) {
	out := new(core2.Proposal)
...
func (c *walletClient) GetExchangeById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Exchange, error) {
	out := new(core2.Exchange)
...
func (c *walletClient) GetChainParameters(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.ChainParameters, error) {
	out := new(core2.ChainParameters)
...
func (c *walletClient) GetTransactionSign(ctx context.Context, in *core2.TransactionSign, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletClient) GetTransactionSign2(ctx context.Context, in *core2.TransactionSign, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetTransactionInfoById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.TransactionInfo, error) {
	out := new(core2.TransactionInfo)
...
func (c *walletClient) AccountPermissionUpdate(ctx context.Context, in *core2.AccountPermissionUpdateContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) AddSign(ctx context.Context, in *core2.TransactionSign, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetTransactionSignWeight(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*TransactionSignWeight, error) {
...
func (c *walletClient) GetTransactionApprovedList(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*TransactionApprovedList, error) {
...
func (c *walletClient) GetNodeInfo(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.NodeInfo, error) {
	out := new(core2.NodeInfo)
...
func (c *walletClient) UpdateBrokerage(ctx context.Context, in *core2.UpdateBrokerageContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetMerkleTreeVoucherInfo(ctx context.Context, in *core2.OutputPointInfo, opts ...grpc.CallOption) (*core2.IncrementalMerkleVoucherInfo, error) {
	out := new(core2.IncrementalMerkleVoucherInfo)
...
func (c *walletClient) GetShieldTransactionHash(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*BytesMessage, error) {
	out := new(BytesMessage)
...
func (c *walletClient) CreateCommonTransaction(ctx context.Context, in *core2.Transaction, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletClient) GetTransactionFromPending(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
type WalletServer interface {
	GetAccount(context.Context, *core2.Account) (*core2.Account, error)
	GetAccountById(context.Context, *core2.Account) (*core2.Account, error)
	GetAccountBalance(context.Context, *core2.AccountBalanceRequest) (*core2.AccountBalanceResponse, error)
	GetBlockBalanceTrace(context.Context, *core2.BlockBalanceTrace_BlockIdentifier) (*core2.BlockBalanceTrace, error)
	//Please use CreateTransaction2 instead of this function.
	CreateTransaction(context.Context, *core2.TransferContract) (*core2.Transaction, error)
	//Use this function instead of CreateTransaction.
	CreateTransaction2(context.Context, *core2.TransferContract) (*TransactionExtention, error)
	BroadcastTransaction(context.Context, *core2.Transaction) (*Return, error)
	//Please use UpdateAccount2 instead of this function.
	UpdateAccount(context.Context, *core2.AccountUpdateContract) (*core2.Transaction, error)
	SetAccountId(context.Context, *core2.SetAccountIdContract) (*core2.Transaction, error)
	//Use this function instead of UpdateAccount.
	UpdateAccount2(context.Context, *core2.AccountUpdateContract) (*TransactionExtention, error)
	//Please use VoteWitnessAccount2 instead of this function.
	VoteWitnessAccount(context.Context, *core2.VoteWitnessContract) (*core2.Transaction, error)
	//modify the consume_user_resource_percent
	UpdateSetting(context.Context, *core2.UpdateSettingContract) (*TransactionExtention, error)
	//modify the energy_limit
	UpdateEnergyLimit(context.Context, *core2.UpdateEnergyLimitContract) (*TransactionExtention, error)
	//Use this function instead of VoteWitnessAccount.
	VoteWitnessAccount2(context.Context, *core2.VoteWitnessContract) (*TransactionExtention, error)
	//Please use CreateAssetIssue2 instead of this function.
	CreateAssetIssue(context.Context, *core2.AssetIssueContract) (*core2.Transaction, error)
	//Use this function instead of CreateAssetIssue.
	CreateAssetIssue2(context.Context, *core2.AssetIssueContract) (*TransactionExtention, error)
	//Please use UpdateWitness2 instead of this function.
	UpdateWitness(context.Context, *core2.WitnessUpdateContract) (*core2.Transaction, error)
	//Use this function instead of UpdateWitness.
	UpdateWitness2(context.Context, *core2.WitnessUpdateContract) (*TransactionExtention, error)
	//Please use CreateAccount2 instead of this function.
	CreateAccount(context.Context, *core2.AccountCreateContract) (*core2.Transaction, error)
	//Use this function instead of CreateAccount.
	CreateAccount2(context.Context, *core2.AccountCreateContract) (*TransactionExtention, error)
	//Please use CreateWitness2 instead of this function.
	CreateWitness(context.Context, *core2.WitnessCreateContract) (*core2.Transaction, error)
	//Use this function instead of CreateWitness.
	CreateWitness2(context.Context, *core2.WitnessCreateContract) (*TransactionExtention, error)
	//Please use TransferAsset2 instead of this function.
	TransferAsset(context.Context, *core2.TransferAssetContract) (*core2.Transaction, error)
	//Use this function instead of TransferAsset.
	TransferAsset2(context.Context, *core2.TransferAssetContract) (*TransactionExtention, error)
	//Please use ParticipateAssetIssue2 instead of this function.
	ParticipateAssetIssue(context.Context, *core2.ParticipateAssetIssueContract) (*core2.Transaction, error)
	//Use this function instead of ParticipateAssetIssue.
	ParticipateAssetIssue2(context.Context, *core2.ParticipateAssetIssueContract) (*TransactionExtention, error)
	//Please use FreezeBalance2 instead of this function.
	FreezeBalance(context.Context, *core2.FreezeBalanceContract) (*core2.Transaction, error)
	//Use this function instead of FreezeBalance.
	FreezeBalance2(context.Context, *core2.FreezeBalanceContract) (*TransactionExtention, error)
	//Please use UnfreezeBalance2 instead of this function.
	UnfreezeBalance(context.Context, *core2.UnfreezeBalanceContract) (*core2.Transaction, error)
	//Use this function instead of UnfreezeBalance.
	UnfreezeBalance2(context.Context, *core2.UnfreezeBalanceContract) (*TransactionExtention, error)
	//Please use UnfreezeAsset2 instead of this function.
	UnfreezeAsset(context.Context, *core2.UnfreezeAssetContract) (*core2.Transaction, error)
	//Use this function instead of UnfreezeAsset.
	UnfreezeAsset2(context.Context, *core2.UnfreezeAssetContract) (*TransactionExtention, error)
	//Please use WithdrawBalance2 instead of this function.
	WithdrawBalance(context.Context, *core2.WithdrawBalanceContract) (*core2.Transaction, error)
	//Use this function instead of WithdrawBalance.
	WithdrawBalance2(context.Context, *core2.WithdrawBalanceContract) (*TransactionExtention, error)
	//Please use UpdateAsset2 instead of this function.
	UpdateAsset(context.Context, *core2.UpdateAssetContract) (*core2.Transaction, error)
	//Use this function instead of UpdateAsset.
	UpdateAsset2(context.Context, *core2.UpdateAssetContract) (*TransactionExtention, error)
	ProposalCreate(context.Context, *core2.ProposalCreateContract) (*TransactionExtention, error)
	ProposalApprove(context.Context, *core2.ProposalApproveContract) (*TransactionExtention, error)
	ProposalDelete(context.Context, *core2.ProposalDeleteContract) (*TransactionExtention, error)
	BuyStorage(context.Context, *core2.BuyStorageContract) (*TransactionExtention, error)
	BuyStorageBytes(context.Context, *core2.BuyStorageBytesContract) (*TransactionExtention, error)
	SellStorage(context.Context, *core2.SellStorageContract) (*TransactionExtention, error)
	ExchangeCreate(context.Context, *core2.ExchangeCreateContract) (*TransactionExtention, error)
	ExchangeInject(context.Context, *core2.ExchangeInjectContract) (*TransactionExtention, error)
	ExchangeWithdraw(context.Context, *core2.ExchangeWithdrawContract) (*TransactionExtention, error)
	ExchangeTransaction(context.Context, *core2.ExchangeTransactionContract) (*TransactionExtention, error)
	MarketSellAsset(context.Context, *core2.MarketSellAssetContract) (*TransactionExtention, error)
	MarketCancelOrder(context.Context, *core2.MarketCancelOrderContract) (*TransactionExtention, error)
	GetMarketOrderById(context.Context, *BytesMessage) (*core2.MarketOrder, error)
	GetMarketOrderByAccount(context.Context, *BytesMessage) (*core2.MarketOrderList, error)
	GetMarketPriceByPair(context.Context, *core2.MarketOrderPair) (*core2.MarketPriceList, error)
	GetMarketOrderListByPair(context.Context, *core2.MarketOrderPair) (*core2.MarketOrderList, error)
	GetMarketPairList(context.Context, *EmptyMessage) (*core2.MarketOrderPairList, error)
	ListNodes(context.Context, *EmptyMessage) (*NodeList, error)
	GetAssetIssueByAccount(context.Context, *core2.Account) (*AssetIssueList, error)
	GetAccountNet(context.Context, *core2.Account) (*AccountNetMessage, error)
	GetAccountResource(context.Context, *core2.Account) (*AccountResourceMessage, error)
	GetAssetIssueByName(context.Context, *BytesMessage) (*core2.AssetIssueContract, error)
	GetAssetIssueListByName(context.Context, *BytesMessage) (*AssetIssueList, error)
	GetAssetIssueById(context.Context, *BytesMessage) (*core2.AssetIssueContract, error)
	//Please use GetNowBlock2 instead of this function.
	GetNowBlock(context.Context, *EmptyMessage) (*core2.Block, error)
	//Use this function instead of GetNowBlock.
	GetNowBlock2(context.Context, *EmptyMessage) (*BlockExtention, error)
	//Please use GetBlockByNum2 instead of this function.
	GetBlockByNum(context.Context, *NumberMessage) (*core2.Block, error)
	//Use this function instead of GetBlockByNum.
	...
	GetBlockById(context.Context, *BytesMessage) (*core2.Block, error)
	//Please use GetBlockByLimitNext2 instead of this function.
	...
	GetTransactionById(context.Context, *BytesMessage) (*core2.Transaction, error)
	DeployContract(context.Context, *core2.CreateSmartContract) (*TransactionExtention, error)
	GetContract(context.Context, *BytesMessage) (*core2.SmartContract, error)
	GetContractInfo(context.Context, *BytesMessage) (*core2.SmartContractDataWrapper, error)
	TriggerContract(context.Context, *core2.TriggerSmartContract) (*TransactionExtention, error)
	TriggerConstantContract(context.Context, *core2.TriggerSmartContract) (*TransactionExtention, error)
	ClearContractABI(context.Context, *core2.ClearABIContract) (*TransactionExtention, error)
	...
	GetDelegatedResourceAccountIndex(context.Context, *BytesMessage) (*core2.DelegatedResourceAccountIndex, error)
	...
	GetProposalById(context.Context, *BytesMessage) (*core2.Proposal, error)
	...
	GetExchangeById(context.Context, *BytesMessage) (*core2.Exchange, error)
	GetChainParameters(context.Context, *EmptyMessage) (*core2.ChainParameters, error)
	...
	//Warning: do not invoke this interface provided by others.
	//Please use GetTransactionSign2 instead of this function.
	GetTransactionSign(context.Context, *core2.TransactionSign) (*core2.Transaction, error)
	//Warning: do not invoke this interface provided by others.
	//Use this function instead of GetTransactionSign.
	GetTransactionSign2(context.Context, *core2.TransactionSign) (*TransactionExtention, error)
	//Warning: do not invoke this interface provided by others.
	...
	GetTransactionInfoById(context.Context, *BytesMessage) (*core2.TransactionInfo, error)
	AccountPermissionUpdate(context.Context, *core2.AccountPermissionUpdateContract) (*TransactionExtention, error)
	AddSign(context.Context, *core2.TransactionSign) (*TransactionExtention, error)
	GetTransactionSignWeight(context.Context, *core2.Transaction) (*TransactionSignWeight, error)
	GetTransactionApprovedList(context.Context, *core2.Transaction) (*TransactionApprovedList, error)
	GetNodeInfo(context.Context, *EmptyMessage) (*core2.NodeInfo, error)
	...
	UpdateBrokerage(context.Context, *core2.UpdateBrokerageContract) (*TransactionExtention, error)
	// for shiededTransaction
	CreateShieldedTransaction(context.Context, *PrivateParameters) (*TransactionExtention, error)
	GetMerkleTreeVoucherInfo(context.Context, *core2.OutputPointInfo) (*core2.IncrementalMerkleVoucherInfo, error)
	...
	GetShieldTransactionHash(context.Context, *core2.Transaction) (*BytesMessage, error)
	...
	CreateCommonTransaction(context.Context, *core2.Transaction) (*TransactionExtention, error)
	...
	GetTransactionFromPending(context.Context, *BytesMessage) (*core2.Transaction, error)
...
func (*UnimplementedWalletServer) GetAccount(context.Context, *core2.Account) (*core2.Account, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccount not implemented")
}
func (*UnimplementedWalletServer) GetAccountById(context.Context, *core2.Account) (*core2.Account, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccountById not implemented")
}
func (*UnimplementedWalletServer) GetAccountBalance(context.Context, *core2.AccountBalanceRequest) (*core2.AccountBalanceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccountBalance not implemented")
}
func (*UnimplementedWalletServer) GetBlockBalanceTrace(context.Context, *core2.BlockBalanceTrace_BlockIdentifier) (*core2.BlockBalanceTrace, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlockBalanceTrace not implemented")
}
func (*UnimplementedWalletServer) CreateTransaction(context.Context, *core2.TransferContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTransaction not implemented")
}
func (*UnimplementedWalletServer) CreateTransaction2(context.Context, *core2.TransferContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTransaction2 not implemented")
}
func (*UnimplementedWalletServer) BroadcastTransaction(context.Context, *core2.Transaction) (*Return, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BroadcastTransaction not implemented")
}
func (*UnimplementedWalletServer) UpdateAccount(context.Context, *core2.AccountUpdateContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAccount not implemented")
}
func (*UnimplementedWalletServer) SetAccountId(context.Context, *core2.SetAccountIdContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetAccountId not implemented")
}
func (*UnimplementedWalletServer) UpdateAccount2(context.Context, *core2.AccountUpdateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAccount2 not implemented")
}
func (*UnimplementedWalletServer) VoteWitnessAccount(context.Context, *core2.VoteWitnessContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VoteWitnessAccount not implemented")
}
func (*UnimplementedWalletServer) UpdateSetting(context.Context, *core2.UpdateSettingContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateSetting not implemented")
}
func (*UnimplementedWalletServer) UpdateEnergyLimit(context.Context, *core2.UpdateEnergyLimitContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateEnergyLimit not implemented")
}
func (*UnimplementedWalletServer) VoteWitnessAccount2(context.Context, *core2.VoteWitnessContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VoteWitnessAccount2 not implemented")
}
func (*UnimplementedWalletServer) CreateAssetIssue(context.Context, *core2.AssetIssueContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAssetIssue not implemented")
}
func (*UnimplementedWalletServer) CreateAssetIssue2(context.Context, *core2.AssetIssueContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAssetIssue2 not implemented")
}
func (*UnimplementedWalletServer) UpdateWitness(context.Context, *core2.WitnessUpdateContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateWitness not implemented")
}
func (*UnimplementedWalletServer) UpdateWitness2(context.Context, *core2.WitnessUpdateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateWitness2 not implemented")
}
func (*UnimplementedWalletServer) CreateAccount(context.Context, *core2.AccountCreateContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAccount not implemented")
}
func (*UnimplementedWalletServer) CreateAccount2(context.Context, *core2.AccountCreateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAccount2 not implemented")
}
func (*UnimplementedWalletServer) CreateWitness(context.Context, *core2.WitnessCreateContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateWitness not implemented")
}
func (*UnimplementedWalletServer) CreateWitness2(context.Context, *core2.WitnessCreateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateWitness2 not implemented")
}
func (*UnimplementedWalletServer) TransferAsset(context.Context, *core2.TransferAssetContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransferAsset not implemented")
}
func (*UnimplementedWalletServer) TransferAsset2(context.Context, *core2.TransferAssetContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransferAsset2 not implemented")
}
func (*UnimplementedWalletServer) ParticipateAssetIssue(context.Context, *core2.ParticipateAssetIssueContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParticipateAssetIssue not implemented")
}
func (*UnimplementedWalletServer) ParticipateAssetIssue2(context.Context, *core2.ParticipateAssetIssueContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParticipateAssetIssue2 not implemented")
}
func (*UnimplementedWalletServer) FreezeBalance(context.Context, *core2.FreezeBalanceContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FreezeBalance not implemented")
}
func (*UnimplementedWalletServer) FreezeBalance2(context.Context, *core2.FreezeBalanceContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FreezeBalance2 not implemented")
}
func (*UnimplementedWalletServer) UnfreezeBalance(context.Context, *core2.UnfreezeBalanceContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnfreezeBalance not implemented")
}
func (*UnimplementedWalletServer) UnfreezeBalance2(context.Context, *core2.UnfreezeBalanceContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnfreezeBalance2 not implemented")
}
func (*UnimplementedWalletServer) UnfreezeAsset(context.Context, *core2.UnfreezeAssetContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnfreezeAsset not implemented")
}
func (*UnimplementedWalletServer) UnfreezeAsset2(context.Context, *core2.UnfreezeAssetContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnfreezeAsset2 not implemented")
}
func (*UnimplementedWalletServer) WithdrawBalance(context.Context, *core2.WithdrawBalanceContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WithdrawBalance not implemented")
}
func (*UnimplementedWalletServer) WithdrawBalance2(context.Context, *core2.WithdrawBalanceContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WithdrawBalance2 not implemented")
}
func (*UnimplementedWalletServer) UpdateAsset(context.Context, *core2.UpdateAssetContract) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAsset not implemented")
}
func (*UnimplementedWalletServer) UpdateAsset2(context.Context, *core2.UpdateAssetContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAsset2 not implemented")
}
func (*UnimplementedWalletServer) ProposalCreate(context.Context, *core2.ProposalCreateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProposalCreate not implemented")
}
func (*UnimplementedWalletServer) ProposalApprove(context.Context, *core2.ProposalApproveContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProposalApprove not implemented")
}
func (*UnimplementedWalletServer) ProposalDelete(context.Context, *core2.ProposalDeleteContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProposalDelete not implemented")
}
func (*UnimplementedWalletServer) BuyStorage(context.Context, *core2.BuyStorageContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuyStorage not implemented")
}
func (*UnimplementedWalletServer) BuyStorageBytes(context.Context, *core2.BuyStorageBytesContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuyStorageBytes not implemented")
}
func (*UnimplementedWalletServer) SellStorage(context.Context, *core2.SellStorageContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SellStorage not implemented")
}
func (*UnimplementedWalletServer) ExchangeCreate(context.Context, *core2.ExchangeCreateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExchangeCreate not implemented")
}
func (*UnimplementedWalletServer) ExchangeInject(context.Context, *core2.ExchangeInjectContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExchangeInject not implemented")
}
func (*UnimplementedWalletServer) ExchangeWithdraw(context.Context, *core2.ExchangeWithdrawContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExchangeWithdraw not implemented")
}
func (*UnimplementedWalletServer) ExchangeTransaction(context.Context, *core2.ExchangeTransactionContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExchangeTransaction not implemented")
}
func (*UnimplementedWalletServer) MarketSellAsset(context.Context, *core2.MarketSellAssetContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MarketSellAsset not implemented")
}
func (*UnimplementedWalletServer) MarketCancelOrder(context.Context, *core2.MarketCancelOrderContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MarketCancelOrder not implemented")
}
func (*UnimplementedWalletServer) GetMarketOrderById(context.Context, *BytesMessage) (*core2.MarketOrder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketOrderById not implemented")
}
func (*UnimplementedWalletServer) GetMarketOrderByAccount(context.Context, *BytesMessage) (*core2.MarketOrderList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketOrderByAccount not implemented")
}
func (*UnimplementedWalletServer) GetMarketPriceByPair(context.Context, *core2.MarketOrderPair) (*core2.MarketPriceList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketPriceByPair not implemented")
}
func (*UnimplementedWalletServer) GetMarketOrderListByPair(context.Context, *core2.MarketOrderPair) (*core2.MarketOrderList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketOrderListByPair not implemented")
}
func (*UnimplementedWalletServer) GetMarketPairList(context.Context, *EmptyMessage) (*core2.MarketOrderPairList, error) {
...
func (*UnimplementedWalletServer) GetAssetIssueByAccount(context.Context, *core2.Account) (*AssetIssueList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAssetIssueByAccount not implemented")
}
func (*UnimplementedWalletServer) GetAccountNet(context.Context, *core2.Account) (*AccountNetMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccountNet not implemented")
}
func (*UnimplementedWalletServer) GetAccountResource(context.Context, *core2.Account) (*AccountResourceMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccountResource not implemented")
}
func (*UnimplementedWalletServer) GetAssetIssueByName(context.Context, *BytesMessage) (*core2.AssetIssueContract, error) {
...
func (*UnimplementedWalletServer) GetAssetIssueById(context.Context, *BytesMessage) (*core2.AssetIssueContract, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAssetIssueById not implemented")
}
func (*UnimplementedWalletServer) GetNowBlock(context.Context, *EmptyMessage) (*core2.Block, error) {
...
func (*UnimplementedWalletServer) GetBlockByNum(context.Context, *NumberMessage) (*core2.Block, error) {
...
func (*UnimplementedWalletServer) GetBlockById(context.Context, *BytesMessage) (*core2.Block, error) {
...
func (*UnimplementedWalletServer) GetTransactionById(context.Context, *BytesMessage) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionById not implemented")
}
func (*UnimplementedWalletServer) DeployContract(context.Context, *core2.CreateSmartContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeployContract not implemented")
}
func (*UnimplementedWalletServer) GetContract(context.Context, *BytesMessage) (*core2.SmartContract, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetContract not implemented")
}
func (*UnimplementedWalletServer) GetContractInfo(context.Context, *BytesMessage) (*core2.SmartContractDataWrapper, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetContractInfo not implemented")
}
func (*UnimplementedWalletServer) TriggerContract(context.Context, *core2.TriggerSmartContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TriggerContract not implemented")
}
func (*UnimplementedWalletServer) TriggerConstantContract(context.Context, *core2.TriggerSmartContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TriggerConstantContract not implemented")
}
func (*UnimplementedWalletServer) ClearContractABI(context.Context, *core2.ClearABIContract) (*TransactionExtention, error) {
...
func (*UnimplementedWalletServer) GetDelegatedResourceAccountIndex(context.Context, *BytesMessage) (*core2.DelegatedResourceAccountIndex, error) {
...
func (*UnimplementedWalletServer) GetProposalById(context.Context, *BytesMessage) (*core2.Proposal, error) {
...
func (*UnimplementedWalletServer) GetExchangeById(context.Context, *BytesMessage) (*core2.Exchange, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetExchangeById not implemented")
}
func (*UnimplementedWalletServer) GetChainParameters(context.Context, *EmptyMessage) (*core2.ChainParameters, error) {
...
func (*UnimplementedWalletServer) GetTransactionSign(context.Context, *core2.TransactionSign) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionSign not implemented")
}
func (*UnimplementedWalletServer) GetTransactionSign2(context.Context, *core2.TransactionSign) (*TransactionExtention, error) {
...
func (*UnimplementedWalletServer) GetTransactionInfoById(context.Context, *BytesMessage) (*core2.TransactionInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionInfoById not implemented")
}
func (*UnimplementedWalletServer) AccountPermissionUpdate(context.Context, *core2.AccountPermissionUpdateContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AccountPermissionUpdate not implemented")
}
func (*UnimplementedWalletServer) AddSign(context.Context, *core2.TransactionSign) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddSign not implemented")
}
func (*UnimplementedWalletServer) GetTransactionSignWeight(context.Context, *core2.Transaction) (*TransactionSignWeight, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionSignWeight not implemented")
}
func (*UnimplementedWalletServer) GetTransactionApprovedList(context.Context, *core2.Transaction) (*TransactionApprovedList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionApprovedList not implemented")
}
func (*UnimplementedWalletServer) GetNodeInfo(context.Context, *EmptyMessage) (*core2.NodeInfo, error) {
...
func (*UnimplementedWalletServer) UpdateBrokerage(context.Context, *core2.UpdateBrokerageContract) (*TransactionExtention, error) {
...
func (*UnimplementedWalletServer) GetMerkleTreeVoucherInfo(context.Context, *core2.OutputPointInfo) (*core2.IncrementalMerkleVoucherInfo, error) {
...
func (*UnimplementedWalletServer) GetShieldTransactionHash(context.Context, *core2.Transaction) (*BytesMessage, error) {
...
func (*UnimplementedWalletServer) CreateCommonTransaction(context.Context, *core2.Transaction) (*TransactionExtention, error) {
...
func (*UnimplementedWalletServer) GetTransactionFromPending(context.Context, *BytesMessage) (*core2.Transaction, error) {
...
func _Wallet_GetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetAccount(ctx, req.(*core2.Account))
	}
...
func _Wallet_GetAccountById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetAccountById(ctx, req.(*core2.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetAccountBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.AccountBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetAccountBalance(ctx, req.(*core2.AccountBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetBlockBalanceTrace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.BlockBalanceTrace_BlockIdentifier)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetBlockBalanceTrace(ctx, req.(*core2.BlockBalanceTrace_BlockIdentifier))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateTransaction(ctx, req.(*core2.TransferContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateTransaction2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateTransaction2(ctx, req.(*core2.TransferContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_BroadcastTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).BroadcastTransaction(ctx, req.(*core2.Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.AccountUpdateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateAccount(ctx, req.(*core2.AccountUpdateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_SetAccountId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.SetAccountIdContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).SetAccountId(ctx, req.(*core2.SetAccountIdContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateAccount2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateAccount2(ctx, req.(*core2.AccountUpdateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_VoteWitnessAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.VoteWitnessContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).VoteWitnessAccount(ctx, req.(*core2.VoteWitnessContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateSetting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.UpdateSettingContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateSetting(ctx, req.(*core2.UpdateSettingContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateEnergyLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.UpdateEnergyLimitContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateEnergyLimit(ctx, req.(*core2.UpdateEnergyLimitContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_VoteWitnessAccount2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).VoteWitnessAccount2(ctx, req.(*core2.VoteWitnessContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateAssetIssue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.AssetIssueContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateAssetIssue(ctx, req.(*core2.AssetIssueContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateAssetIssue2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateAssetIssue2(ctx, req.(*core2.AssetIssueContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateWitness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.WitnessUpdateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateWitness(ctx, req.(*core2.WitnessUpdateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateWitness2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateWitness2(ctx, req.(*core2.WitnessUpdateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.AccountCreateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateAccount(ctx, req.(*core2.AccountCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateAccount2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateAccount2(ctx, req.(*core2.AccountCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateWitness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.WitnessCreateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateWitness(ctx, req.(*core2.WitnessCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateWitness2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateWitness2(ctx, req.(*core2.WitnessCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_TransferAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.TransferAssetContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).TransferAsset(ctx, req.(*core2.TransferAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_TransferAsset2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).TransferAsset2(ctx, req.(*core2.TransferAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ParticipateAssetIssue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ParticipateAssetIssueContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ParticipateAssetIssue(ctx, req.(*core2.ParticipateAssetIssueContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ParticipateAssetIssue2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ParticipateAssetIssue2(ctx, req.(*core2.ParticipateAssetIssueContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_FreezeBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.FreezeBalanceContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).FreezeBalance(ctx, req.(*core2.FreezeBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_FreezeBalance2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).FreezeBalance2(ctx, req.(*core2.FreezeBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UnfreezeBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.UnfreezeBalanceContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UnfreezeBalance(ctx, req.(*core2.UnfreezeBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UnfreezeBalance2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UnfreezeBalance2(ctx, req.(*core2.UnfreezeBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UnfreezeAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.UnfreezeAssetContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UnfreezeAsset(ctx, req.(*core2.UnfreezeAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UnfreezeAsset2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UnfreezeAsset2(ctx, req.(*core2.UnfreezeAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_WithdrawBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.WithdrawBalanceContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).WithdrawBalance(ctx, req.(*core2.WithdrawBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_WithdrawBalance2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).WithdrawBalance2(ctx, req.(*core2.WithdrawBalanceContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.UpdateAssetContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateAsset(ctx, req.(*core2.UpdateAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateAsset2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateAsset2(ctx, req.(*core2.UpdateAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ProposalCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ProposalCreateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ProposalCreate(ctx, req.(*core2.ProposalCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ProposalApprove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ProposalApproveContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ProposalApprove(ctx, req.(*core2.ProposalApproveContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ProposalDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ProposalDeleteContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ProposalDelete(ctx, req.(*core2.ProposalDeleteContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_BuyStorage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.BuyStorageContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).BuyStorage(ctx, req.(*core2.BuyStorageContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_BuyStorageBytes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.BuyStorageBytesContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).BuyStorageBytes(ctx, req.(*core2.BuyStorageBytesContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_SellStorage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.SellStorageContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).SellStorage(ctx, req.(*core2.SellStorageContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ExchangeCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ExchangeCreateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ExchangeCreate(ctx, req.(*core2.ExchangeCreateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ExchangeInject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ExchangeInjectContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ExchangeInject(ctx, req.(*core2.ExchangeInjectContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ExchangeWithdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ExchangeWithdrawContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ExchangeWithdraw(ctx, req.(*core2.ExchangeWithdrawContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ExchangeTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.ExchangeTransactionContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ExchangeTransaction(ctx, req.(*core2.ExchangeTransactionContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_MarketSellAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.MarketSellAssetContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).MarketSellAsset(ctx, req.(*core2.MarketSellAssetContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_MarketCancelOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.MarketCancelOrderContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).MarketCancelOrder(ctx, req.(*core2.MarketCancelOrderContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetMarketPriceByPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetMarketPriceByPair(ctx, req.(*core2.MarketOrderPair))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetMarketOrderListByPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetMarketOrderListByPair(ctx, req.(*core2.MarketOrderPair))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetAssetIssueByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetAssetIssueByAccount(ctx, req.(*core2.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetAccountNet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetAccountNet(ctx, req.(*core2.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetAccountResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetAccountResource(ctx, req.(*core2.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_DeployContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.CreateSmartContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).DeployContract(ctx, req.(*core2.CreateSmartContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_TriggerContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.TriggerSmartContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).TriggerContract(ctx, req.(*core2.TriggerSmartContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_TriggerConstantContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).TriggerConstantContract(ctx, req.(*core2.TriggerSmartContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_ClearContractABI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).ClearContractABI(ctx, req.(*core2.ClearABIContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetTransactionSign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetTransactionSign(ctx, req.(*core2.TransactionSign))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetTransactionSign2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetTransactionSign2(ctx, req.(*core2.TransactionSign))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_AccountPermissionUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.AccountPermissionUpdateContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).AccountPermissionUpdate(ctx, req.(*core2.AccountPermissionUpdateContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_AddSign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).AddSign(ctx, req.(*core2.TransactionSign))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetTransactionSignWeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetTransactionSignWeight(ctx, req.(*core2.Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetTransactionApprovedList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetTransactionApprovedList(ctx, req.(*core2.Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_UpdateBrokerage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(core2.UpdateBrokerageContract)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).UpdateBrokerage(ctx, req.(*core2.UpdateBrokerageContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetMerkleTreeVoucherInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetMerkleTreeVoucherInfo(ctx, req.(*core2.OutputPointInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_GetShieldTransactionHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).GetShieldTransactionHash(ctx, req.(*core2.Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Wallet_CreateCommonTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletServer).CreateCommonTransaction(ctx, req.(*core2.Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (c *walletSolidityClient) GetAccount(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*core2.Account, error) {
	out := new(core2.Account)
...
func (c *walletSolidityClient) GetAccountById(ctx context.Context, in *core2.Account, opts ...grpc.CallOption) (*core2.Account, error) {
	out := new(core2.Account)
...
func (c *walletSolidityClient) GetAssetIssueByName(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.AssetIssueContract, error) {
	out := new(core2.AssetIssueContract)
...
func (c *walletSolidityClient) GetAssetIssueById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.AssetIssueContract, error) {
	out := new(core2.AssetIssueContract)
...
func (c *walletSolidityClient) GetNowBlock(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
func (c *walletSolidityClient) GetBlockByNum(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
func (c *walletSolidityClient) GetDelegatedResourceAccountIndex(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.DelegatedResourceAccountIndex, error) {
	out := new(core2.DelegatedResourceAccountIndex)
...
func (c *walletSolidityClient) GetExchangeById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Exchange, error) {
	out := new(core2.Exchange)
...
func (c *walletSolidityClient) GetTransactionById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.Transaction, error) {
	out := new(core2.Transaction)
...
func (c *walletSolidityClient) GetTransactionInfoById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.TransactionInfo, error) {
	out := new(core2.TransactionInfo)
...
func (c *walletSolidityClient) GetMerkleTreeVoucherInfo(ctx context.Context, in *core2.OutputPointInfo, opts ...grpc.CallOption) (*core2.IncrementalMerkleVoucherInfo, error) {
	out := new(core2.IncrementalMerkleVoucherInfo)
...
func (c *walletSolidityClient) TriggerConstantContract(ctx context.Context, in *core2.TriggerSmartContract, opts ...grpc.CallOption) (*TransactionExtention, error) {
	out := new(TransactionExtention)
...
func (c *walletSolidityClient) GetMarketOrderById(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.MarketOrder, error) {
	out := new(core2.MarketOrder)
...
func (c *walletSolidityClient) GetMarketOrderByAccount(ctx context.Context, in *BytesMessage, opts ...grpc.CallOption) (*core2.MarketOrderList, error) {
	out := new(core2.MarketOrderList)
...
func (c *walletSolidityClient) GetMarketPriceByPair(ctx context.Context, in *core2.MarketOrderPair, opts ...grpc.CallOption) (*core2.MarketPriceList, error) {
	out := new(core2.MarketPriceList)
...
func (c *walletSolidityClient) GetMarketOrderListByPair(ctx context.Context, in *core2.MarketOrderPair, opts ...grpc.CallOption) (*core2.MarketOrderList, error) {
	out := new(core2.MarketOrderList)
...
func (c *walletSolidityClient) GetMarketPairList(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.MarketOrderPairList, error) {
	out := new(core2.MarketOrderPairList)
...
func (*UnimplementedWalletSolidityServer) GetAccount(context.Context, *core2.Account) (*core2.Account, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccount not implemented")
}
func (*UnimplementedWalletSolidityServer) GetAccountById(context.Context, *core2.Account) (*core2.Account, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccountById not implemented")
}
...
func (*UnimplementedWalletSolidityServer) GetAssetIssueByName(context.Context, *BytesMessage) (*core2.AssetIssueContract, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAssetIssueByName not implemented")
}
func (*UnimplementedWalletSolidityServer) GetAssetIssueListByName(context.Context, *BytesMessage) (*AssetIssueList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAssetIssueListByName not implemented")
}
func (*UnimplementedWalletSolidityServer) GetAssetIssueById(context.Context, *BytesMessage) (*core2.AssetIssueContract, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAssetIssueById not implemented")
}
func (*UnimplementedWalletSolidityServer) GetNowBlock(context.Context, *EmptyMessage) (*core2.Block, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNowBlock not implemented")
}
func (*UnimplementedWalletSolidityServer) GetNowBlock2(context.Context, *EmptyMessage) (*BlockExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNowBlock2 not implemented")
}
func (*UnimplementedWalletSolidityServer) GetBlockByNum(context.Context, *NumberMessage) (*core2.Block, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlockByNum not implemented")
}
...
func (*UnimplementedWalletSolidityServer) GetDelegatedResourceAccountIndex(context.Context, *BytesMessage) (*core2.DelegatedResourceAccountIndex, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDelegatedResourceAccountIndex not implemented")
}
func (*UnimplementedWalletSolidityServer) GetExchangeById(context.Context, *BytesMessage) (*core2.Exchange, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetExchangeById not implemented")
}
func (*UnimplementedWalletSolidityServer) ListExchanges(context.Context, *EmptyMessage) (*ExchangeList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListExchanges not implemented")
}
func (*UnimplementedWalletSolidityServer) GetTransactionById(context.Context, *BytesMessage) (*core2.Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionById not implemented")
}
func (*UnimplementedWalletSolidityServer) GetTransactionInfoById(context.Context, *BytesMessage) (*core2.TransactionInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionInfoById not implemented")
}
func (*UnimplementedWalletSolidityServer) GenerateAddress(context.Context, *EmptyMessage) (*AddressPrKeyPairMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateAddress not implemented")
}
func (*UnimplementedWalletSolidityServer) GetMerkleTreeVoucherInfo(context.Context, *core2.OutputPointInfo) (*core2.IncrementalMerkleVoucherInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMerkleTreeVoucherInfo not implemented")
}
...
func (*UnimplementedWalletSolidityServer) TriggerConstantContract(context.Context, *core2.TriggerSmartContract) (*TransactionExtention, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TriggerConstantContract not implemented")
}
...
func (*UnimplementedWalletSolidityServer) GetMarketOrderById(context.Context, *BytesMessage) (*core2.MarketOrder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketOrderById not implemented")
}
func (*UnimplementedWalletSolidityServer) GetMarketOrderByAccount(context.Context, *BytesMessage) (*core2.MarketOrderList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketOrderByAccount not implemented")
}
func (*UnimplementedWalletSolidityServer) GetMarketPriceByPair(context.Context, *core2.MarketOrderPair) (*core2.MarketPriceList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketPriceByPair not implemented")
}
func (*UnimplementedWalletSolidityServer) GetMarketOrderListByPair(context.Context, *core2.MarketOrderPair) (*core2.MarketOrderList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketOrderListByPair not implemented")
}
func (*UnimplementedWalletSolidityServer) GetMarketPairList(context.Context, *EmptyMessage) (*core2.MarketOrderPairList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMarketPairList not implemented")
}
...
func _WalletSolidity_GetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetAccount(ctx, req.(*core2.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_GetAccountById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetAccountById(ctx, req.(*core2.Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_GetMerkleTreeVoucherInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetMerkleTreeVoucherInfo(ctx, req.(*core2.OutputPointInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_TriggerConstantContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).TriggerConstantContract(ctx, req.(*core2.TriggerSmartContract))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_GetMarketPriceByPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetMarketPriceByPair(ctx, req.(*core2.MarketOrderPair))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WalletSolidity_GetMarketOrderListByPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WalletSolidityServer).GetMarketOrderListByPair(ctx, req.(*core2.MarketOrderPair))
	}
	return interceptor(ctx, in, info, handler)
}
...
type DatabaseClient interface {
	...
	GetDynamicProperties(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.DynamicProperties, error)
	GetNowBlock(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.Block, error)
	GetBlockByNum(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*core2.Block, error)
}
...
func (c *databaseClient) GetDynamicProperties(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.DynamicProperties, error) {
	out := new(core2.DynamicProperties)
...
func (c *databaseClient) GetNowBlock(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
func (c *databaseClient) GetBlockByNum(ctx context.Context, in *NumberMessage, opts ...grpc.CallOption) (*core2.Block, error) {
	out := new(core2.Block)
...
type DatabaseServer interface {
	...
	GetDynamicProperties(context.Context, *EmptyMessage) (*core2.DynamicProperties, error)
	GetNowBlock(context.Context, *EmptyMessage) (*core2.Block, error)
	GetBlockByNum(context.Context, *NumberMessage) (*core2.Block, error)
}
...
func (*UnimplementedDatabaseServer) GetDynamicProperties(context.Context, *EmptyMessage) (*core2.DynamicProperties, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDynamicProperties not implemented")
}
func (*UnimplementedDatabaseServer) GetNowBlock(context.Context, *EmptyMessage) (*core2.Block, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNowBlock not implemented")
}
func (*UnimplementedDatabaseServer) GetBlockByNum(context.Context, *NumberMessage) (*core2.Block, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlockByNum not implemented")
}
...
type MonitorClient interface {
	GetStatsInfo(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.MetricsInfo, error)
}
...
func (c *monitorClient) GetStatsInfo(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*core2.MetricsInfo, error) {
	out := new(core2.MetricsInfo)
...
type MonitorServer interface {
	GetStatsInfo(context.Context, *EmptyMessage) (*core2.MetricsInfo, error)
}
...
func (*UnimplementedMonitorServer) GetStatsInfo(context.Context, *EmptyMessage) (*core2.MetricsInfo, error) {
